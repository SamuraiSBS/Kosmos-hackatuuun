    ...
    <main className="analysis-scene scene-page">
      ...
      {phase === 'error' ? (
        ...
        <div className="analysis-results">
          ...
          <button className="primary-button full-button" type="button" onClick={onChooseDecision} disabled={!showSignal}>Спланировать действие <span>→</span></button>
        </div>
      )}
    </main>
  )
